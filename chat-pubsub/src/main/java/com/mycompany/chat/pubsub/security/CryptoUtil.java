 ...
 * criptografa a msg com chave do topico com RSA, gera chave AES, criptografa
 * e decriptografa mensagens com AES.
 * 
...
public class CryptoUtil {
     ...
     * A chave publica pode ser compartilhada, a chave privada deve ficar protegida
    ...
    /**
     * Converte uma chave publica RSA para texto Base64
     * isso permite enviar a chave em JSON ou salvar em certificado
     * @param chavePublica
     * @return 
     */
    ...
    /**
     * Converte uma chave publica em Base64 de volta para PublicKey
     * BASE TRANSFORMA BYTES EM TEXTO
     * @param chaveBase64
     * @return
     * @throws Exception 
     */
    ...
    /**
     * Assina dados usando uma chave privada RSA 
     * Usado para gerar assinaturas de certificados
     * @param dados
     * @param chavePrivada
     * @return
     * @throws Exception 
    ...
    /**
     * Verifica se uma assinatura foi feita pela chave privada correspondente 
     * a chave publica informada
     * @param dados
  ...
  // ============
    /**
     * Criptografa um texto usando uma chave publica RSA
     * é usada para criptografar a chave AES do topico
     * antes de enviar para um usuario aprovado
     * @param texto
     * @param chavePublica
     * @return
     * @throws Exception 
     ...
     * é usado pelo usuario aprovado para abrir a chave AES
     * do topico que foi criptografado com a chave publica dele
    ...
    /**
     * Gera uma chave AES em Base64
     * essa chave é usada para criptografar msgs dentro de um topico
     * @return
     * @throws Exception 
     */
    ...
    /**
     * criptografa uma msg usando AES/CGM
     * o metodo gera um IV aleatorio para cada msg e retorna:
     * IV_BASE64:CIFRADO_BASE64
     * GCM AJUDA A DETECTAR ALTERAÇOES NO CONTEUDO
     * @param texto
     * @param chaveBase64
     * @return
     * @throws Exception 
    ...
    /**
     * Descriptografa uma msg AES/GCM no formato:
     * IV_BASE64:CIFRADO_BASE64
     * @param textoCifrado
     * @param chaveBase64
     * @return
